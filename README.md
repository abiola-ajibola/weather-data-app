...
- `yarn ingest:weather` runs the worker that reads CSV files from `https://www.ncei.noaa.gov/data/daily-summaries/archive/daily-summaries-latest.tar.gz` and populates the database.
